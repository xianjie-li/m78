...
declare const actionSheetApi: ({ singleton, ...props }: Pick<ActionSheetProps<any>, "title" | "onChange" | "defaultValue" | "value" | "onClose" | "triggerNode" | "options" | "confirm" | "onShowChange"> & import("@lxjx/react-render-api/dist").ReactRenderApiExtraProps) => [import("@lxjx/react-render-api/dist").ReactRenderApiInstance<Pick<ActionSheetProps<any>, "title" | "onChange" | "defaultValue" | "value" | "onClose" | "triggerNode" | "options" | "confirm" | "onShowChange">>, string];
