...
declare const actionSheetApi: ({ singleton, ...props }: Pick<ActionSheetProps<any>, "title" | "onChange" | "defaultValue" | "value" | "confirm" | "triggerNode" | "onClose" | "options" | "onShowChange"> & import("@lxjx/react-render-api/dist").ReactRenderApiExtraProps) => [import("@lxjx/react-render-api/dist").ReactRenderApiInstance<Pick<ActionSheetProps<any>, "title" | "onChange" | "defaultValue" | "value" | "confirm" | "triggerNode" | "onClose" | "options" | "onShowChange">>, string];
