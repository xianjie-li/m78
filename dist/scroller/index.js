...
function useHooks(methods, share) {
  ...
  var bind = useGesture({
    onDrag: function onDrag(_ref) {
      ...
      var yPrevent = props.direction === Direction.vertical && (dy > 0 && sMeta.touchTop || dy < 0 && sMeta.touchBottom);
      var xPrevent = props.direction === Direction.horizontal && (dx > 0 && sMeta.touchLeft || dx < 0 && sMeta.touchRight);
      /* 触边拖动时禁用默认事件 */
