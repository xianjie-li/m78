...
import { AuthKeys, Auth, CreateAuthConfig, Validators, ValidMeta } from '@lxjx/auth';
...
export interface ExpandCreate {
    <D extends AnyObject = AnyObject, V extends Validators<D> = Validators<D>>({ dependency, validators, validFirst, }: CreateAuthConfig<D, V>): ExpandAuth<D, V>;
}
