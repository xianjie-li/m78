...
/** value允许类型 */
export declare type TreeValueType = string | number;
...
/** 单选props */
export interface TreePropsSingleChoice extends TreeProps, FormLikeWithExtra<TreeValueType, TreeNode> {
    /** 是否可单选 (使用高亮样式) */
    checkable?: boolean;
    /** false | 是否可选中目录级 */
    checkTwig?: boolean;
...
/** 多选props */
export interface TreePropsMultipleChoice extends TreeProps, FormLikeWithExtra<TreeValueType[], TreeNode[]> {
...
export declare type DragItemProps = Omit<ItemProps, 'provided' | 'snapshot'>;
