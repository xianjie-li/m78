...
export interface ModalBaseApi extends Omit<ModalBaseProps, 'children' | 'defaultShow' | 'show' | 'triggerNode' | 'mountOnEnter' | 'unmountOnExit' | 'onClose' | 'onRemove' | 'onRemoveDelay'> {
