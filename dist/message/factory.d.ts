...
declare const notify: ({ title, desc, foot, content, ...options }: NotifyOption) => [import("@lxjx/react-render-api/dist").ReactRenderApiInstance<Pick<MessageProps, "loading" | "mask" | "content" | "type" | "loadingDelay" | "duration" | "hasCancel">>, string];
