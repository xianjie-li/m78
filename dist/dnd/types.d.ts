...
export interface DragFullEvent<Data = any, TData = Data> extends Required<DragPartialEvent<Data, TData>> {
}
/** 响应某个DND拖动的事件 */
 ...
 * */
declare type MixAllowDrop = boolean | Partial<AllowPosition>;
