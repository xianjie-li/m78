...
import { AnyFunction, dumpFn, isArray } from "@m78/utils";
 ...
 * */
export function useTrigger<E extends HTMLElement = HTMLElement>(
  config: UseTriggerConfig
) {
