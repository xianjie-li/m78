/** 支持的事件类型 */
export declare enum UseKeyboardTriggerType {
    down = "down",
    up = "up"
}
export declare type UseKeyboardTriggerTypeKeys = keyof typeof UseKeyboardTriggerType;
/** 支持的修饰键 */
export declare enum UseKeyboardModifier {
    alt = "alt",
    ctrl = "ctrl",
    meta = "meta",
    shift = "shift",
...
export declare type UseKeyboardModifierKeys = keyof typeof UseKeyboardModifier;
/** 事件回调 */
export declare type UseKeyboardCallback = (e: UseKeyboardEvent) => void;
/** useKeyboard配置对象 */
 ...
 * - 订阅时间越晚的事件越先触发
 * */
export declare function useKeyboard(option: UseKeyboardOption): void;
