...
<demo demo={require("./_demos/builtIn.tsx")} code={require("!!raw-loader!./_demos/builtIn.tsx")}></demo>

## 定制动画

使用`TransitionBase`来简单的实现各种自定义动画, 可以通过`interpolater`prop 或 render children 来进行更为强大的插值动画

<demo demo={require("./_demos/custom.tsx")} code={require("!!raw-loader!./_demos/custom.tsx")}></demo>
...
<demo demo={require("./_demos/config.tsx")} code={require("!!raw-loader!./_demos/config.tsx")}></demo>
