...
<demo demo={require("././_demos/cells/base.tsx")} code={require("!!raw-loader!././_demos/cells/base.tsx")}></demo>

### 排列行为

通过`mainAlign`和`crossAlign`来分别控制子项在主轴和交叉轴上的布局方式

<demo demo={require("././_demos/cells/layouts.tsx")} code={require("!!raw-loader!././_demos/cells/layouts.tsx")}></demo>
...
<demo demo={require("././_demos/cells/sort.tsx")} code={require("!!raw-loader!././_demos/cells/sort.tsx")}></demo>

### flex

`Cell`支持传入`flex`设置弹性系数

<demo demo={require("././_demos/cells/flex.tsx")} code={require("!!raw-loader!././_demos/cells/flex.tsx")}></demo>

### 响应式栅格

基于后文中的`MediaQuery`组件,  提供了 6 种响应尺寸 `xs` `sm` `md` `lg` `xl` `xxl`

<demo demo={require("./_demos/cells/media-query.tsx")} code={require("!!raw-loader!./_demos/cells/media-query.tsx")}></demo>
...
<demo demo={require("./_demos/media-query/base.tsx")} code={require("!!raw-loader!./_demos/media-query/base.tsx")}></demo>
...
<demo demo={require("./_demos/flex.tsx")} code={require("!!raw-loader!./_demos/flex.tsx")}></demo>
...
<demo demo={require("./_demos/tile.tsx")} code={require("!!raw-loader!./_demos/tile.tsx")}></demo>
...
<demo demo={require("./_demos/aspect-ratio.tsx")} code={require("!!raw-loader!./_demos/aspect-ratio.tsx")}></demo>
...
<demo demo={require("./_demos/divider.tsx")} code={require("!!raw-loader!./_demos/divider.tsx")}></demo>
...
<demo demo={require("./_demos/spacer.tsx")} code={require("!!raw-loader!./_demos/spacer.tsx")}></demo>
...
<demo demo={require("./_demos/center.tsx")} code={require("!!raw-loader!./_demos/center.tsx")}></demo>
