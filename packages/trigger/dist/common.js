...
/** move事件的触发频率(ms) */ export var _triggerLimit = 50;
/** 含first/last的事件的进出延迟 */ export var _triggerInDelay = 80 - _triggerLimit;
/** 含first/last的事件的进出延迟 */ export var _triggerOutDelay = 140;
