...
function fixSize(param) {
  var designWidth = param.designWidth,
    designHeight = param.designHeight,
    keepRatio = param.keepRatio,
    el = param.el;
  ...
  el.style.topFixed = "50%";
  el.style.leftFixed = "50%";
  el.style.transform = "scale3d("
    .concat(xS, ", ")
    .concat(yS, ", 1) translate3d(-50%, -50%, 0)");
