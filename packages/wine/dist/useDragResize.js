...
export function useDragResize(type, ctx, methods) {
    var getRightMeta = function getRightMeta(wrapBound, param) {
    ...
    var getBottomMeta = function getBottomMeta(wrapBound, param) {
    ...
    var getLeftMeta = function getLeftMeta(wrapBound, param) {
        var _param = _sliced_to_array(param, 1), x = _param[0];
    ...
    var getTopMeta = function getTopMeta(wrapBound, param) {
        var _param = _sliced_to_array(param, 2), y = _param[1];
    ...
    useDrag(function(param) {
        var _xy = _sliced_to_array(param.xy, 2), x = _xy[0], y = _xy[1];
