...
export const _RESERVE_BAR_SIZE = 40;

/** 下拉刷新每划动1px实际应移动的距离比例 */
export const _PULL_DOWN_SWIPE_RATIO = 0.5;

/** 下拉刷新触发比例 */
export const _PULL_DOWN_TRIGGER_RATIO = 0.9;
...
/** 滚动条thumb最小尺寸 */
export const _BAR_MIN_SIZE_RATIO = 18;

/** 根据传入的滚动方向返回用于启用滚动条的css style */
export function _getScrollStyleByDirection(dir: ScrollDirectionUnion) {
