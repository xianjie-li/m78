...
import { TableCellConfig, TableCellWithDom, TableColumnConfig, TableRowConfig } from "./items.js";
...
export declare type TableConfigCanNotChanges = typeof _configCanNotChange[number];
/**
...
/** 表格配置 */
export interface TableConfig extends TableSelectConfig, TableEmptyConfig, TableDragSort {
    /** 用于挂载表格的div节点 */
    el: HTMLDivElement;
