...
/** table实例 */
export interface TableInstance extends TableSelect, TableLife, TableEvent, TableHistory, TableMutation, TableHighlight, TableRender, TableGetter, TableSetter, TableIs, TableConfigInstance, TableForm, TableKeyboardInteraction, TableSoftRemove, TableDragMove, TableCoreEls {
}
