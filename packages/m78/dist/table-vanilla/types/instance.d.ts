...
/** table实例 */
export interface TableInstance extends TableGetter, TableSelect, TableDisable, TableLife, TableEvent, TableHistory, TableMutation, TableHighlight, TableSortColumn, TableViewPort {
     ...
     * ```
     * */
    config(config: Omit<Partial<TableConfig>, TableConfigCanNotChanges>, keepPosition?: boolean): void;
}
