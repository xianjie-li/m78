import { _NotifyContext, NotifyPositionUnion, NotifyQuicker, NotifyState } from "./types.js";
/**
 ...
 * */
export declare function _useInteractive(share: _NotifyContext): {
    start: () => void;
    stop: () => void;
};
/**
 ...
 * */
export declare function _useFixPad({ props, bound }: _NotifyContext): readonly [{
    readonly title: {
        paddingRight: string;
    };
    readonly cont: {
 ...
 *
 * */
export declare function _useToggleController(share: _NotifyContext): boolean;
