...
/** 应从Overlay中移除的props */
export declare type DrawerOmitOverlayKeys = typeof omitDrawerOverlayProps[number];
export declare type DrawerOmitOverlayProps = Omit<OverlayProps, DrawerOmitOverlayKeys>;
/**
