...
/** 国际化处理 */ export function _i18nHandle(i18nConf) {
    if (i18nConf) {
        if (i18nConf.appendResource) {
            ...
            Object.entries(i18nConf.appendResource).forEach(function(param) {
                var _param = _sliced_to_array(param, 2), lng = _param[0], resource = _param[1];
        ...
        if (i18nConf.lng) {
            i18n.changeLanguage(i18nConf.lng, function(err) {
