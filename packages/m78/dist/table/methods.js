...
export function _useMethods(ctx, customRender) {
    ...
    var ref = ctx.ref, scrollRef = ctx.scrollRef, scrollContRef = ctx.scrollContRef, state = ctx.state, setState = ctx.setState;
    return {
