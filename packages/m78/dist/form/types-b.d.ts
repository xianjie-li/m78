import { FormConfig as VanillaFormConfig, FormInstance as VanillaFormInstance, FormNamesNotify as VanillaFormNamesNotify, FormSchema as VanillaFormSchema } from "../form-vanilla/index.js";
...
/** 表单控件适配器配置 */
export declare type FormAdaptors = Array<{
    /** 待适配的表单控件 */
...
/** 表单控件适配器 */
export declare type FormAdaptor = (args: any) => React.ReactElement;
export declare type FormRegisterConfig = FormKeyCustomer & {
    component: React.ReactElement;
};
/** 创建form实例时传入的配置 */
export interface FormConfig extends Omit<VanillaFormConfig, OmitType | "schemas">, FormProps {
    /** 描述表单值结构的对象 */
...
export interface FormSchema extends Omit<VanillaFormSchema, "label" | "dynamic" | "schema" | "eachSchema">, FormCommonProps {
    /** 动态设置其他参数 */
    dynamic?: (form: FormInstance) => Omit<FormSchemaWithoutName, "dynamic" | "name" | "list" | "deps"> | void;
    /** 类型为数组、对象时, 对其结构进行验证 */
    schema?: FormSchema[];
...
export interface FormInstance extends Omit<VanillaFormInstance, "getSchemas" | "setSchemas" | "getSchema" | "events" | "getConfig"> {
    ...
    events: {
        ...
        fail: CustomEventWithHook<(errors: RejectMeta, isValueChangeTrigger?: boolean) => void>;
        /** 重置事件 */
...
export interface FormProps {
     ...
     * */
    wrapCustomer?: (args: FormCustomRenderArgs, node: React.ReactElement) => React.ReactElement;
...
export declare const _formKeyCustomerKeys: string[];
 ...
 * */
export interface FormListProps<Item = any> extends Omit<FormFieldProps, "children" | "component" | "componentProps" | "fieldCustomer" | keyof FormKeyCustomer> {
 ...
 * */
export interface FormListCustomRenderArgs<Item = any> extends Omit<FormCustomRenderArgs, "bind"> {
    /** 用于渲染列表 */
...
export {};
//# sourceMappingURL=types-b.d.ts.map