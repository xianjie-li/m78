...
/** 剔除内部占用属性的原生按钮props */
type HTMLBtnOmit = Omit<React.PropsWithoutRef<JSX.IntrinsicElements['button']>, 'color'>;

/** 剔除内部占用属性的原生html link props */
type HTMLLinkOmit = Omit<React.PropsWithoutRef<JSX.IntrinsicElements['a']>, 'color' | 'type'>;
