...
const Demo = () => {
  ...
  return (
    <div>
      ...
      <div className="mt-16">
        <Input prefix="身份证号:" value={idCard} onChange={value => setIdCard(value)} format="idCard" />
      </div>
      <div className="mt-16">
        <Input prefix="银行卡号:" value={bankCard} onChange={value => setBankCard(value)} format="bankCard" />
      </div>
      <div className="mt-16">
      ...
      <div style={{ marginTop: 60 }}>
        <h2>自定义匹配模式</h2>
        <Input prefix="手机号:" value={phone} onChange={value => setPhone(value)} formatPattern="3,4" />
      </div>
      <div className="mt-16">
