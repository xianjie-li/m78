  ...
  return (
    <div>
      ...
      <Ellipsis line={3} style={style} disabled={disabled}>
        A dicta libero maiores minima nihil omnis rem rerum temporibus, totam? Alias assumenda, dignissimos.
        Eligendi, eos fugiat, ipsa ipsum laborum nostrum numquam saepe sequi sint temporibus ut, velit voluptate
        voluptatem?
        A dicta libero maiores minima nihil omnis rem rerum temporibus, totam? Alias assumenda, dignissimos.
        Eligendi, eos fugiat, ipsa ipsum laborum nostrum numquam saepe sequi sint temporibus ut, velit voluptate
        voluptatem?
      ...
      <Ellipsis forceCompat style={style} disabled={disabled}>
        <div>文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本</div>
        <div>文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本文本</div>
      </Ellipsis>

      <p className="mt-32">支持单行与多行、动态fontSize和lineHeight(出于性能考虑，只在初始化时读取行高和字号进行计算)</p>
