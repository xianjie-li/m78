import '@lxjx/fr/esm/list/style';
import _objectSpread from '@babel/runtime/helpers/objectSpread2';
import _extends from '@babel/runtime/helpers/extends';
import _objectWithoutProperties from '@babel/runtime/helpers/objectWithoutProperties';
import React, { useContext } from 'react';
import '@lxjx/fr/esm/base';
import { Switch, If } from '@lxjx/fr/esm/fork';
import { statusIcons, LoadingOutlined, RightOutlined } from '@lxjx/fr/esm/icon';
import Ellipsis from '@lxjx/fr/esm/ellipsis';
...
var Title = function Title(_ref) {
  ...
  return /*#__PURE__*/React.createElement("h2", _extends({
    className: cls('fr-list_main-title', className)
  }, props), /*#__PURE__*/React.createElement("div", {
    className: "fr-list_main-title-primary"
  }, title), /*#__PURE__*/React.createElement("div", {
    className: "fr-list_main-title-second"
  }, desc));
};
...
var SubTitle = function SubTitle(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("h3", _extends({
    className: cls('fr-list_sub-title', className)
  }, props), title);
};
...
var Footer = function Footer(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: "fr-list_main-footer ".concat(className || '')
  }, props), children);
};
...
var Item = function Item(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: cls('fr-list_item __md', className, status && "__".concat(status), {
      __disabled: disabled,
      'fr-effect': hasEffect
    }),
    style: _objectSpread(_objectSpread({}, itemStyle), style)
  }, props), /*#__PURE__*/React.createElement("div", {
    className: cls('fr-list_left', leftAlign && "__".concat(leftAlign))
  }, left), /*#__PURE__*/React.createElement("div", {
    className: "fr-list_cont"
  }, /*#__PURE__*/React.createElement("div", {
    className: "fr-list_cont-left"
  }, /*#__PURE__*/React.createElement(Ellipsis, {
    line: titleEllipsis,
    className: cls('fr-list_title')
  }, title, required && /*#__PURE__*/React.createElement("i", {
    className: "fr-list_require",
    title: "\u5FC5\u586B\u9879"
  }, "*")), desc && /*#__PURE__*/React.createElement(Ellipsis, {
    className: cls('fr-list_desc'),
    line: descEllipsis
  }, desc)), isForm && /*#__PURE__*/React.createElement("div", {
    className: "fr-list_cont-right"
  }, children)), /*#__PURE__*/React.createElement("div", {
    className: "fr-list_right"
  }, extra), /*#__PURE__*/React.createElement("div", {
    className: "fr-list_icon"
  }, /*#__PURE__*/React.createElement(Switch, null, /*#__PURE__*/React.createElement(If, {
    when: status
  }, function () {
    return status === 'loading' ? /*#__PURE__*/React.createElement(LoadingOutlined, {
      spin: true
    }) : /*#__PURE__*/React.createElement(StatusIcon, {
      className: "fr-list_extra-icon fr-svg-icon"
    });
