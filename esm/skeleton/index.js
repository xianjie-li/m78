import '@lxjx/fr/esm/skeleton/style';
  ...
  function renderLineBox() {
    ...
    return Array.from({
      ...
      return /*#__PURE__*/React.createElement("div", {
        key: ind,
        className: "fr-skeleton_line-box"
      }, Array.from({
        length: last ? 3 : 5
      }).map(function (v, i) {
        return /*#__PURE__*/React.createElement("div", {
...
var _Banner = function _Banner(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: cls('fr-skeleton fr-skeleton_banner', {
      __shadow: shadow
    }),
    style: {
      width: width,
    ...
    className: "fr-skeleton_banner-main fr-skeleton_animate",
    style: {
      height: height
    }
