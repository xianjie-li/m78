...
import List, { Title, SubTitle, Footer } from '@lxjx/fr/esm/list';
export { Footer, default as List, SubTitle, Title } from '@lxjx/fr/esm/list';
import Schema from 'async-validator';
import { isArray, isEmpty, createRandString, isFunction } from '@lxjx/utils';
import { useScroll, useFn } from '@lxjx/hooks';
import { getFirstScrollParent, checkElementVisible } from '@lxjx/fr/esm/util';
...
var Item = function Item(props) {
  ...
  var selector = nameString ? "FR-FORM-ITEM-".concat(formId, "-").concat(nameString) : undefined;
...
var BaseForm = function BaseForm(props) {
  ...
  var finishFailedHandle = useFn(function (arg) {
    ...
    if (!firstName) return;
    var el = document.getElementById("FR-FORM-ITEM-".concat(id, "-").concat(getNameString(firstName)));
    if (!el) return;
  ...
  return /*#__PURE__*/React.createElement(context.Provider, {
    ...
    form: true,
    style: style,
    className: cls(className, 'fr-form', contextValue.hideRequiredMark && '__hide-required-mark'),
    notBorder: notBorder,
    layout: layout,
    column: column,
    fullWidth: fullWidth,
