import '@lxjx/fr/esm/select/style';
import _objectSpread from '@babel/runtime/helpers/objectSpread2';
import _slicedToArray from '@babel/runtime/helpers/slicedToArray';
import React, { useRef, useState, useEffect } from 'react';
import Input from '@lxjx/fr/esm/input';
import Popper from '@lxjx/fr/esm/popper';
import Spin from '@lxjx/fr/esm/spin';
import Empty from '@lxjx/fr/esm/empty';
import Button from '@lxjx/fr/esm/button';
import { CloseCircleOutlined, CheckOutlined, DownOutlined } from '@lxjx/fr/esm/icon';
import { If } from '@lxjx/fr/esm/fork';
import { getFirstTruthyOrZero, getCurrentParent } from '@lxjx/fr/esm/util';
...
function CustomPopper(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "fr-popper_content fr-select_popper"
  }, content);
}
...
var buildInTagRender = function buildInTagRender(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("span", {
    className: cls(className, 'fr-select_tag'),
    key: key
  }, /*#__PURE__*/React.createElement("span", {
    className: "fr-select_close-btn",
    title: "\u5220\u9664"
...
function Select(props) {
  ...
  var onShow = useFn(function (_ref) {
    ...
    if (target) {
      var isCloseBtn = getCurrentParent(target, function (node) {
        return node.className === 'fr-select_close-btn';
      }, 5);
  ...
  function renderList() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: cls('fr-select_list fr-scroll-bar', {
        __disabled: disabled
      }),
      style: {
  ...
  function renderToolbar() {
    var bar = /*#__PURE__*/React.createElement("div", {
      className: "fr-select_toolbar-inner fr-hb-t"
    }, /*#__PURE__*/React.createElement("div", {
  ...
  return /*#__PURE__*/React.createElement(Popper, {
    ...
    suffix: /*#__PURE__*/React.createElement(DownOutlined, {
      className: cls('fr-select_down-icon', {
        __reverse: show
      })
    }),
    value: inpVal,
