...
var builtIn = {
  radio: function radio(meta) {
    return /*#__PURE__*/React.createElement("span", {
      className: cls('fr-check_base fr-effect __md', getCheckCls(meta))
    }, /*#__PURE__*/React.createElement("span", {
      className: "fr-check_base-main"
    }, /*#__PURE__*/React.createElement("span", {
      className: "fr-check_base-inner"
    })));
  },
  checkbox: function checkbox(meta, _ref2) {
    var partial = _ref2.partial;
    return /*#__PURE__*/React.createElement("span", {
      className: cls('fr-check_base fr-effect __md', '__checkbox', partial && '__partial', getCheckCls(meta))
    }, /*#__PURE__*/React.createElement("span", {
      className: "fr-check_base-main"
    }, /*#__PURE__*/React.createElement("span", {
      className: "fr-check_base-inner"
  ...
  "switch": function _switch(meta, _ref3) {
    ...
    return /*#__PURE__*/React.createElement("span", {
      className: cls('fr-check_switch', getCheckCls(meta))
    }, /*#__PURE__*/React.createElement("span", {
      className: cls('fr-check_switch-inner fr-effect __md', meta.disabled && '__disabled')
    }, /*#__PURE__*/React.createElement("span", {
      className: "fr-check_switch-handle"
...
var Check = function Check(_props) {
  ...
  return (
    ...
    React.createElement("label", {
      ...
      className: "fr-check_label-before"
