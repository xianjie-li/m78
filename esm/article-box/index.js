import '@lxjx/fr/esm/article-box/style';
...
var ArticleBox = function ArticleBox(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: ref,
    className: cls('fr-article-box', className),
    style: style
  }, /*#__PURE__*/React.createElement(If, {
    when: html
  }, function () {
    return /*#__PURE__*/React.createElement("div", {
      className: "fr-article-box_html",
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "fr-article-box_watermark"
    }, Array.from({
      length: row
    }).map(function (rowItem, rowKey) {
      return /*#__PURE__*/React.createElement("div", {
        className: "fr-article-box_watermark_item",
        key: rowKey
      }, Array.from({
        length: col
