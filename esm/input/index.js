import '@lxjx/fr/esm/input/style';
...
import { CloseCircleOutlined, EyeOutlined, EyeInvisibleOutlined, SearchOutlined } from '@lxjx/fr/esm/icon';
...
import { validateFormatString, isNumber, formatString } from '@lxjx/utils';
...
var Input = /*#__PURE__*/React.forwardRef(function (_props, ref) {
  ...
  function formatVal(val) {
    ...
    // eslint-disable-next-line
    var formatValue = formatArg ? formatString.apply(void 0, [val].concat(_toConsumableArray(formatArg))) : val; // 对money类型特殊处理
  ...
  return /*#__PURE__*/React.createElement("span", {
    className: cls('fr-input_wrap', className, status && "__".concat(status), size && "__".concat(size), {
    ...
    return /*#__PURE__*/React.cloneElement(prefixBtn, {
      className: 'fr-input_prefix-btn'
    });
  }), /*#__PURE__*/React.createElement(If, {
    when: prefix && !textArea
  }, /*#__PURE__*/React.createElement("span", {
    className: "fr-input_prefix"
    ...
    onClick: clearHandle,
    className: "fr-input_icon fr-input_icon-clear"
  })), /*#__PURE__*/React.createElement(If, {
    ...
    className: "fr-input_search-icon",
    icon: true,
    win: true,
    size: "small",
