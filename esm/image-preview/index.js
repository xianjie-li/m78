import '@lxjx/fr/esm/image-preview/style';
...
import Carousel from '@lxjx/fr/esm/carousel';
import Viewer from '@lxjx/fr/esm/viewer';
import Picture from '@lxjx/fr/esm/picture';
import { LeftOutlined, UndoOutlined, RedoOutlined, ZoomInOutlined, ZoomOutOutlined, SyncOutlined, RightOutlined, CloseCircleOutlined } from '@lxjx/fr/esm/icon';
...
var _ImagePreview = function _ImagePreview(_ref) {
  ...
  var bindDrag = useDrag(function (_ref2) {
    ...
    if (last && memo) {
      ...
      var timeOver = time - memo < 220; // 220ms内
  ...
  return /*#__PURE__*/React.createElement(Portal, {
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: key,
      className: "fr-image-preview_img-wrap"
    ...
    className: "fr-image-preview_ctrl-bar",
    onDoubleClick: stopPropagation.onClick
