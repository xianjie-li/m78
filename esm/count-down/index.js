import '@lxjx/fr/esm/count-down/style';
...
function wTime(s, extra) {
  return "<span class=\"".concat(cls('fr-count-down_time', extra), "\">").concat(s, "</span>");
}

function wTxt(s, extra) {
  return "<span class=\"".concat(cls('fr-count-down_text', extra), "\">").concat(s, "</span>");
}
...
var CountDown = function CountDown(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", {
    className: cls('fr-count-down', className),
    style: style,
    ref: ref
  });
};
